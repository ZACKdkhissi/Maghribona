...
//             <Route path="users">
//               <Route index element={<ProtectedRoute><List element={userColumns} /></ProtectedRoute>} />
...
//             </Route>
//             <Route path="hotels">
//               <Route index element={<ProtectedRoute><List element={hotelColumns} /></ProtectedRoute>} />
...
import AddHotel from "./pages/new/AddHotel";
import AddRoom from "./pages/new/AddRoom";
        ...
        <Routes>
          <Route path="/">
            ...
            <Route
                ...
                element={
                  <ProtectedRoute>
                    <New inputs={hotelInputs} title="Add New Hotels" />
                  </ProtectedRoute>
                }
              />
              <Route
